    ...
    render() {
        ...
        return (
            <View style={{ alignItems: 'center', flexDirection: 'column' }}>
                ...
                {this.props.mesa.Cod_Mesa!='DEV' ?<TouchableOpacity ref='ref_Mesa' activeOpacity={0.7} onPress={this.props.SeleccionarMesa} style={{
                ...
                <TouchableOpacity ref='ref_Mesa' activeOpacity={0.7} onPress={this.props.SeleccionarMesa} style={{
                    marginBottom: 10, height: this.props.width_state / 5, width: this.props.width_state-20,
                    justifyContent: 'center',
                    backgroundColor: '#FFF', alignItems: 'center', borderColor: ColorMesa(this.state.Estado_Mesa), borderWidth: 2,
